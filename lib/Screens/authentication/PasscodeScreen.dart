...
import 'package:limitless.chat_admin/Screens/authentication/Setupdata.dart';
...
import 'package:limitless.chat_admin/Screens/bottomnavbar/BottomNavBarAdminApp.dart';
import 'package:limitless.chat_admin/Screens/errorScreens/ErrorScreen.dart';
  ...
  checkdevice(BuildContext context) async {
    ...
    await FirebaseFirestore.instance
      ...
      if (docsetting.exists) {
        print("doc data is:${docsetting.data()}");
        ...
        if (Platform.isAndroid == true || Platform.isIOS == true) {
          ...
          print('allow save db ${isCollectDeviceInfoAndSavetoDatabase}');
          if (isCollectDeviceInfoAndSavetoDatabase == true) {
