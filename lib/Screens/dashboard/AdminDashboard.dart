...
import 'package:limitless.chat_admin/Configs/App_constants.dart';
import 'package:limitless.chat_admin/Configs/DbPaths.dart';
import 'package:limitless.chat_admin/Configs/Dbkeys.dart';
import 'package:limitless.chat_admin/Screens/reports/allreports.dart';
...
import 'package:limitless.chat_admin/Screens/networkSensitiveUi/NetworkSensitiveUi.dart';
import 'package:limitless.chat_admin/Utils/Utils.dart';
import 'package:limitless.chat_admin/Configs/Mycolors.dart';
import 'package:limitless.chat_admin/Widgets/Buttons.dart';
import 'package:limitless.chat_admin/Widgets/CustomCard.dart';
import 'package:limitless.chat_admin/Fonts/MyText.dart';
import 'package:limitless.chat_admin/Widgets/MyInkWell.dart';
import 'package:limitless.chat_admin/Widgets/avatars/customCircleAvatars.dart';
import 'package:limitless.chat_admin/Widgets/dashboardElements/dashboardwidgets.dart';
import 'package:limitless.chat_admin/Widgets/dialogs/loadingDialog.dart';
import 'package:limitless.chat_admin/Widgets/pageNavigator.dart';
import 'package:limitless.chat_admin/Widgets/tiles.dart';
...
class _AdmindashboardState extends State<Admindashboard> {
  ...
  fetchData() async {
    ...
    print("session is ${session.chatData}");
      ...
      if (userSettingsDoc.exists) {
        if (userSettingsDoc.data()!.containsKey(Dbkeys.usersidesetupdone)) {
          ...
          await FirebaseFirestore.instance
            ...
            print("users count ${userCountDoc.data()!['totalapprovedusers']}");
            if (userCountDoc.exists) {
              ...
              await FirebaseFirestore.instance
                ...
                if (chatDataDoc.exists) {
                  ...
                  Utils.toast(
                      "User App is not setup yet. Kindly Install the User App");
          ...
          Utils.toast("User App is not setup yet. Kindly Install the User App");
          setTemporaryUnavailable(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      dashboardCard(
                                                          ...
                                                          label: 'Audio Calls',
                                                          value:
                                                              '${session.chatData['audiocallsmade'] == null ? 0 : session.chatData['audiocallsmade']}',
                                                          iconData:
                                                              Icons.phone),
                                                      dashboardCard(
                                                          width: w / 2.3,
                                                          ...
                                                          label: 'Video Calls',
                                                          value:
                                                              '${session.chatData['videocallsmade'] == null ? 0 : session.chatData['videocallsmade']}',
                                                          iconData:
                                                              Icons.video_call),
                                                    ],
                                                  ),
                                                  Row(
                                                    ...
                                                    children: [
                                                      dashboardCard(
                                                        ...
                                                        label: 'Users',
                                                        value:
                                                            "${session.userCount['totalapprovedusers'] + session.userCount['totalblockedusers']}",
                                                      ),
                                                      dashboardCard(
                                                          width: w / 3.6,
                                                          cardColor:
                                                          ...
                                                          label: 'Media',
                                                          value:
                                                              "${session.chatData['mediamessagessent'] == null ? 0 : session.chatData['mediamessagessent']}",
                                                          iconData:
                                                              Icons.play_arrow),
                                                      dashboardCard(
                                                          width: w / 3.6,
